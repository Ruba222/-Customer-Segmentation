...
def main():
    ...
    with col_new2:
        ...
        new_price_per_item = st.number_input("Price (per item)", min_value=0.00, value=0.00, format="%.2f", key="new_price_per_item")
    ...
    if st.button("Predict Segment", key="predict_segment_button"):
        ...
        if is_existing_customer:
            ...
            if new_transaction_provided:
                ...
                calculated_recency = max(0, (snapshot_date - new_transaction_date_dt).days)
                calculated_orders = 1
